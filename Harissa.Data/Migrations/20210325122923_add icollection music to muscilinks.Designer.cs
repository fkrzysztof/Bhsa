...
namespace Harissa.Data.Migrations
{
    ...
    [Migration("20210325122923_add icollection music to muscilinks")]
    partial class addicollectionmusictomuscilinks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicMusicPlatform", b =>
                {
                    b.Property<int>("MusicLinksMusicID")
                        .HasColumnType("int");

                    b.Property<int>("MusicPlatformsMusicPlatformID")
                        .HasColumnType("int");

                    b.HasKey("MusicLinksMusicID", "MusicPlatformsMusicPlatformID");

                    b.HasIndex("MusicPlatformsMusicPlatformID");

                    b.ToTable("MusicMusicPlatform");
                });
            ...
            modelBuilder.Entity("MusicMusicPlatform", b =>
                {
                    b.HasOne("Harissa.Data.Data.Music", null)
                        .WithMany()
                        .HasForeignKey("MusicLinksMusicID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Harissa.Data.Data.MusicPlatform", null)
                        .WithMany()
                        .HasForeignKey("MusicPlatformsMusicPlatformID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
